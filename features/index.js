...
var law = new Law_1["default"](1, "Should there be a carbon tax on cars?", new Date(), new Date(), true);
// 3 politician
var politician = new Politician_1["default"](1, "Santi Pornavalai", 25, true, "Afd");
