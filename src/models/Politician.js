...
var Politician = /** @class */ (function (_super) {
    ...
    Politician.build = function (attrs) {
        return new Politician(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(this.rootUrl));
    };
    Politician.buildCollection = function () {
        var _this = this;
        return new Collection_1.Collection(this.rootUrl, function (json) { return _this.build(json); });
    };
    ...
    Politician.rootUrl = "http://localhost:3000/politicians";
    return Politician;
}(Model_1.Model));
