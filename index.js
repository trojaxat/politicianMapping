...
var law = new Law_1.Law(1, "Should there be a carbon tax on cars?", new Date(), new Date(), true);
// 3 politician
var politician = new Politician_1.Politician(1, "Santi Pornavalai", 25, true, "Afd", 13.4930915, 52.4930915);
